<section id="activities" class="py-32 bg-gray-50">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-20 fade-up">
            ...
            <p class="text-gray-600 tracking-[0.1em]">Activities</p>
        </div>

        <div class="max-w-6xl mx-auto" style="display: flex; flex-direction: column; gap: 8rem;">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center fade-up" data-delay="200">
                ...
                <div class="space-y-6">
                    <h3 class="text-2xl md:text-3xl tracking-[0.15em]"><?php echo esc_html( get_theme_mod( 'tozem_act_block1_title', __('BBQ', 'tozem') ) ); ?></h3>
                    ...
                    <div class="space-y-4 pt-6 border-t border-gray-200">
                        <p class="text-sm text-gray-600 leading-relaxed">
                            <?php echo esc_html( get_theme_mod( 'tozem_act_block1_price', __('利用料: 5,000円/日（コンロ、網、トング、テーブル等の機材一式）', 'tozem') ) ); ?><br />
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center fade-up" data-delay="400">
                ...
                <div class="space-y-6 lg:order-1">
                    <h3 class="text-2xl md:text-3xl tracking-[0.15em]"><?php echo esc_html( get_theme_mod( 'tozem_act_block2_title', __('海遊び・釣り', 'tozem') ) ); ?></h3>
                    <p class="text-gray-700 leading-loose tracking-[0.05em]">
                    ...
                    <div class="space-y-4 pt-6 border-t border-gray-200">
                        <p class="text-sm text-gray-600 leading-relaxed">
                            ...
                            <span class="text-xs text-gray-500"><?php echo esc_html( get_theme_mod( 'tozem_act_block2_note', __('※海水浴場（波左間、沖の島など）へも車で5〜15分でアクセス可能です。', 'tozem') ) ); ?></span>
                        </p>
                    </div>
                </div>
            </div>

            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center fade-up" data-delay="600">
                <div class="aspect-[4/3] overflow-hidden">
                    <img 
                ...
                <div class="space-y-6">
                    <h3 class="text-2xl md:text-3xl tracking-[0.15em]"><?php echo esc_html( get_theme_mod( 'tozem_act_block3_title', __('周辺スポット', 'tozem') ) ); ?></h3>
                    <div class="space-y-8">
                        <div class="space-y-4">
                            <h4 class="text-lg tracking-[0.1em] border-b border-gray-200 pb-2"><?php echo esc_html( get_theme_mod( 'tozem_act_list1_title', __('アクティビティ', 'tozem') ) ); ?></h4>
                                ...
                                foreach ( $items1 as $item ) {
                                    if ( trim( $item ) ) {
                                        if ( strpos( $item, ':' ) !== false ) {
                                            ...
                                            echo '<li><span class="font-medium">' . esc_html( trim( $bold ) ) . ':</span> ' . esc_html( trim( $normal ) ) . '</li>';
                        ...
                        <div class="space-y-4">
                            <h4 class="text-lg tracking-[0.1em] border-b border-gray-200 pb-2"><?php echo esc_html( get_theme_mod( 'tozem_act_list2_title', __('観光・癒やし', 'tozem') ) ); ?></h4>
                            <ul class="text-sm text-gray-600 space-y-3">
                                <?php
