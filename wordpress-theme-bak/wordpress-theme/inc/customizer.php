...
function tozem_customize_register( $wp_customize ) {
    ...
    $sections = array(
        'hero' => array('label' => 'ヒーロー (トップ画像)', 'default' => 10),
        'news' => array('label' => 'ニュース/ブログ', 'default' => 20),
        'concept' => array('label' => 'コンセプト (藤ゼムとは)', 'default' => 30),
        'stay' => array('label' => '宿泊', 'default' => 40),
        'experience' => array('label' => '体験', 'default' => 50),
        'activities' => array('label' => 'アクティビティ', 'default' => 60),
        'local-guide' => array('label' => '周辺ガイド', 'default' => 70),
        'gallery' => array('label' => 'ギャラリー', 'default' => 80),
        'story' => array('label' => 'ストーリー', 'default' => 90),
        'access' => array('label' => 'アクセス', 'default' => 100),
        'price' => array('label' => '料金案内', 'default' => 105),
        'reservation' => array('label' => 'ご予約・お問い合わせ', 'default' => 110),
    );
    ...
    $wp_customize->add_control( 'tozem_access_public_bus_route', array( 'label' => __( '公共交通1 (バス): ルート', 'tozem' ), 'section' => 'tozem_access_section', 'type' => 'text' ) );
    ...
    $wp_customize->add_control( 'tozem_access_public_train_route', array( 'label' => __( '公共交通2 (電車): ルート', 'tozem' ), 'section' => 'tozem_access_section', 'type' => 'text' ) );
